# === Logs preprocessing script for model training ===
...
LOG_PATH = "../data/raw_logs/syn_unlab_ceph_logs.log"
OUTPUT_PATH = "../data/processed_logs/processed_logs.csv"
...
def main():
    ...
    # ✅ Safely write CSV with minimal quoting (for commas in messages)
...
if __name__ == "__main__":
    ...
    tokenized_path = "../data/processed_logs/tokenized_dataset"
